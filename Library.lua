...
Frame_1.Size = UDim2.new(0, 194, 0, 30)
Frame_1.Position = UDim2.new(0.5, 0, 0.8999999761581421, 0)
Frame_1.AutomaticSize = Enum.AutomaticSize.None
Frame_1.AnchorPoint = Vector2.new(0.5, 0.8999999761581421)
...
Frame_2.Position = UDim2.new(0, 0, 0.26923078298568726, 0)
...
Frame_5.Position = UDim2.new(0.5, 0, 1, 0)
Frame_5.AutomaticSize = Enum.AutomaticSize.None
Frame_5.AnchorPoint = Vector2.new(0.5, 1)
...
TextLabel_1.Text = "Not getting scammed $20 from Templehook"
...
UIGradient_3.Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(96, 119, 189)), ColorSequenceKeypoint.new(1, Color3.fromRGB(100, 112, 168))})
local function CreateNotification(message_text, duration)
    duration = duration or 3
TextLabel_1.Text = message_text

    Frame_1.Position = UDim2.new(0.5, 0, 1.1, 0)
    Frame_1.Visible = true

    local tween_service = game:GetService("TweenService")

    local tween_in = tween_service:Create(Frame_1, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
        Position = UDim2.new(0.5, 0, 0.9, 0)
    })
    tween_in:Play()

    task.delay(duration, function()
        local tween_out = tween_service:Create(Frame_1, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
